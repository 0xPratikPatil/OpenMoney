...
const calloutVariants = cva(
  "my-4 flex gap-2 rounded-lg border border-s-2 bg-card p-3 text-sm text-card-foreground shadow-md border-dashed rounded-none",
  {
    variants: {
      type: {
    ...
    return (
      <div ref={ref}
        ...
        {icon ?? {
          ...
          warn: <TriangleAlert className="size-5 fill-orange-500 text-card" />,
          error: <CircleX className="size-5 fill-red-500 text-card" />,
          success: <CircleCheck className="size-5 fill-green-500 text-card" />,
        }[type]}
